...
// Responsive variants live next to the standard by naming convention:
//   .../0.webp -> .../0-thumb.webp (300px) | .../0-medium.webp (600px)
function variantUrl(raw, suffix) {
    const u = normPath(raw);
    return /\.webp$/.test(u) ? u.replace(/\.webp$/, `-${suffix}.webp`) : u;
}
...
.footer__details,.footer__menu{height:auto}
@media (max-width:767px){.footer__details{margin-bottom:1.25rem}.footer__menu{margin-bottom:1.25rem}}
...
.pt-modal .pm-title{font-family:var(--pt-serif);font-weight:700;font-variation-settings:"wdth" 120;letter-spacing:-.02em;font-size:clamp(30px,3.6vw,58px);line-height:1;text-transform:uppercase;margin:0 0 26px;word-break:normal!important;overflow-wrap:normal!important;hyphens:none!important}
...
<span class="text-10 b768:text-navy py-5 b768:py-0 b768:mb-5 flex relative"><img src="/assets/dbh/logo.png" alt="Dialed By H" width="438" height="58" style="height:22px;width:166px;filter:invert(1)"></span>
<ul class="footer__details text-14 flex flex-col">
...
<ul class="footer__menu text-14 flex flex-col">
...
<ul class="footer__menu flex flex-col">
...
<div class="col-span-24 b768:col-span-4 border text-14">
<span class="text-10 b768:text-navy py-5 b768:py-0 b768:mb-5 flex relative">Brands</span>
<ul class="footer__menu flex flex-col">
<li class="menu-item"><a href="/rolex">Rolex</a></li>
<li class="menu-item"><a href="/patek-philippe">Patek Philippe</a></li>
<li class="menu-item"><a href="/audemars-piguet">Audemars Piguet</a></li>
<li class="menu-item"><a href="/richard-mille">Richard Mille</a></li>
<li class="menu-item"><a href="/vacheron-constantin">Vacheron Constantin</a></li>
<li class="menu-item"><a href="/cartier">Cartier</a></li>
<li class="menu-item"><a href="/fp-journe">F.P. Journe</a></li>
<li class="menu-item"><a href="/a-lange-sohne">A. Lange &amp; S&ouml;hne</a></li>
</ul></div>
</div>
