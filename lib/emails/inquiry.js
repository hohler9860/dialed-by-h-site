  ...
  const detailRows = detailData.map((d, i, arr) =>
    React.createElement("tr", { key: i },
      React.createElement("td", {
        ...
        style: {
          color: C.muted, WebkitTextFillColor: C.muted, fontSize: "10px", fontWeight: "700",
      ...
      React.createElement("td", {
        ...
        style: {
          color: C.heading, WebkitTextFillColor: C.heading, fontSize: "14px", fontFamily: FONT.body, fontWeight: "700",
  ...
  return React.createElement(
    ...
    emailShell([
      ...
      row(C.card, "38px 48px 24px", "left", [
        React.createElement("div", { key: "hdr" }, headerBlock("Request received", "On it.", piece)),
