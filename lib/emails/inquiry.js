...
const {
  ...
  ctaButton, signoff, socialIcons, footer, featureItem, headerBlock,
} = require("./welcome.js");
  ...
  return React.createElement(
    ...
    emailShell([
      ...
      row(C.card, "40px 48px 28px", "left", [
        ...
        }, `${firstName ? firstName + ", thanks" : "Thanks"} for your interest in the ${piece}. I\u2019m personally reviewing availability, condition, and pricing now.`),
        React.createElement(Text, {
