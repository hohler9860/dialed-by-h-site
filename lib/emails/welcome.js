...
// ── Die-cut watch stickers (the site's signature; the white die-cut edge
//    keeps them legible on any background, light or dark) ─────
...
// ── Shared CSS ───────────────────────────────────────────────
// The @media block only fires in clients that honor prefers-color-scheme
// (Apple Mail, Outlook macOS). Gmail app ignores it and force-inverts our
// high-contrast palette instead, which lands close to the same look.
const SHARED_STYLES = `
  @media (prefers-color-scheme: dark) {
    .email-bg { background-color: #0a0a0a !important; }
    .heading-text { color: #f0f0f0 !important; }
    .body-text { color: #b5b5b5 !important; }
    .muted-text, .tag-text { color: #8a8a8a !important; }
    .divider-line { border-color: #262626 !important; }
    .btn-td { background-color: #ffffff !important; }
    .btn-cta { background-color: #ffffff !important; color: #0a0a0a !important; }
    .quote-cell { border-color: #f0f0f0 !important; }
    .disclaimer-text { color: #5a5a5a !important; }
    .footer-text { color: #8a8a8a !important; }
    .footer-link { color: #d5d5d5 !important; }
    .detail-label { color: #8a8a8a !important; }
    .detail-value { color: #e5e5e5 !important; }
    .detail-border { border-color: #262626 !important; }
    .feature-num { color: #8a8a8a !important; }
  }
...
// tiny mono trust strip under the CTA — objections answered before scrolling
function trustLine() {
  return row(C.card, "22px 48px 0", "center",
    React.createElement(Text, {
      className: "muted-text trust-line",
      style: { color: C.muted, fontSize: "9px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "2px", textTransform: "uppercase", margin: "0", lineHeight: "1.8" },
    }, "<12hr response · Independent authentication · Insured delivery")
  );
}
...
function signoff(text) {
  return row(C.card, "32px 48px 8px", "left", [
    ...
    React.createElement(Text, {
      key: "s3", className: "muted-text",
      style: { color: C.muted, fontSize: "9px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "2.5px", textTransform: "uppercase", margin: "0" },
    }, "Dialed By H · BOS · NYC · MIA"),
  ]);
}
...
module.exports = {
  ...
  pickSticker, headerBlock, quoteBlock, trustLine, sectionLabel,
};
