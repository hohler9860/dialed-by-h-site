...
// ── Shared CSS ───────────────────────────────────────────────
// DARK-MODE AWARE. We declare "light dark" support (see emailHead) so clients —
// including the aggressive Gmail Android/iOS apps — stop force-inverting our
// text into an unreadable grey-on-white mush. Instead we ship an explicit,
// readable dark version below: a dark card with light text and an inverted
// (white) button. Rules use !important to beat the inline color locks, and are
// duplicated with [data-ogsc]/[data-ogsb] selectors because the Gmail apps tag
// each element they recolor with those attributes rather than honoring @media.
const DARK_RULES = `
    body, .email-bg, .btn-td { background-color: #121212 !important; background-image: linear-gradient(#121212,#121212) !important; }
    .heading-text, .heading-main, .detail-value, .feature-title { color: #f4f4f4 !important; -webkit-text-fill-color: #f4f4f4 !important; }
    .body-text, .body-main, .feature-desc { color: #ececec !important; -webkit-text-fill-color: #ececec !important; }
    .tag-text, .muted-text, .detail-label, .footer-text, .feature-num { color: #b6b6b6 !important; -webkit-text-fill-color: #b6b6b6 !important; }
    .disclaimer-text { color: #949494 !important; -webkit-text-fill-color: #949494 !important; }
    .footer-link { color: #ededed !important; -webkit-text-fill-color: #ededed !important; }
    .divider-line { border-color: #333333 !important; }
    .quote-cell { border-left-color: #f4f4f4 !important; }
    .btn-td, .btn-cta { background-color: #ffffff !important; background-image: linear-gradient(#ffffff,#ffffff) !important; }
    .btn-cta { color: #0a0a0a !important; -webkit-text-fill-color: #0a0a0a !important; }
`;
const SHARED_STYLES = `
  ...
  /* Gmail Android/iOS apps tag each recolored element with data-ogsc (text) or
     data-ogsb (background) — target those directly since they skip @media. */
  .heading-text[data-ogsc], .heading-main[data-ogsc], .detail-value[data-ogsc], .feature-title[data-ogsc] { color: #f4f4f4 !important; -webkit-text-fill-color: #f4f4f4 !important; }
  .body-text[data-ogsc], .body-main[data-ogsc], .feature-desc[data-ogsc] { color: #ececec !important; -webkit-text-fill-color: #ececec !important; }
  .tag-text[data-ogsc], .muted-text[data-ogsc], .detail-label[data-ogsc], .footer-text[data-ogsc], .feature-num[data-ogsc] { color: #b6b6b6 !important; -webkit-text-fill-color: #b6b6b6 !important; }
  .disclaimer-text[data-ogsc] { color: #949494 !important; -webkit-text-fill-color: #949494 !important; }
  .footer-link[data-ogsc] { color: #ededed !important; -webkit-text-fill-color: #ededed !important; }
  .btn-cta[data-ogsc] { color: #0a0a0a !important; -webkit-text-fill-color: #0a0a0a !important; }
  .email-bg[data-ogsb], .btn-td[data-ogsb] { background-color: #121212 !important; }
  .btn-td[data-ogsb] { background-color: #ffffff !important; }
`;
    ...
    React.createElement("tr", null,
      React.createElement("td", { style: { verticalAlign: "top" } },
        React.createElement(Text, {
          className: "tag-text",
          style: { color: C.tag, WebkitTextFillColor: C.tag, fontSize: "10px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "4px", textTransform: "uppercase", margin: "0 0 18px" },
        }, tag),
        React.createElement(Text, {
          className: "heading-text heading-main animate-slide",
          style: { color: C.heading, WebkitTextFillColor: C.heading, fontSize: "38px", fontWeight: "800", letterSpacing: "-0.5px", lineHeight: "1.05", margin: "0", fontFamily: FONT.heading, textTransform: "uppercase", fontStretch: "125%" },
        }, headline)
      ),
        ...
        React.createElement("td", {
          ...
          React.createElement(Link, {
            ...
            style: {
              ...
              color: C.btnText, WebkitTextFillColor: C.btnText,
              fontSize: "11px",
              fontWeight: "700",
    ...
    React.createElement(
      ...
      React.createElement("tr", null,
        React.createElement("td", {
          ...
          React.createElement(Text, {
            className: "body-text",
            style: { color: C.body, WebkitTextFillColor: C.body, fontSize: "14px", lineHeight: "1.7", fontFamily: FONT.body, margin: "0 0 10px", fontStyle: "italic" },
          }, `“${quote}”`),
          React.createElement(Text, {
            className: "muted-text",
            style: { color: C.muted, WebkitTextFillColor: C.muted, fontSize: "10px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "2.5px", textTransform: "uppercase", margin: "0" },
          }, `${name} · ${role}`)
        )
      )
    )
...
function signoff(text) {
  return row(C.card, "32px 48px 8px", "left", [
    React.createElement(Text, {
      ...
      style: { color: C.body, WebkitTextFillColor: C.body, fontSize: "15px", lineHeight: "1.7", fontFamily: FONT.body, margin: "0 0 6px" },
    }, text || "Talk soon,"),
    React.createElement(Text, {
      key: "s2", className: "heading-text",
      style: { color: C.heading, WebkitTextFillColor: C.heading, fontSize: "16px", fontFamily: FONT.heading, margin: "0 0 4px", fontWeight: "800", textTransform: "uppercase", letterSpacing: "1px", fontStretch: "125%" },
    }, "Henry"),
  ]);
}
...
function socialIcons() {
  const linkStyle = {
    color: C.heading, WebkitTextFillColor: C.heading, fontSize: "10px", fontWeight: "700", fontFamily: FONT.mono,
    letterSpacing: "2.5px", textTransform: "uppercase", textDecoration: "underline",
  };
  const dotStyle = { padding: "0 10px", color: C.muted, WebkitTextFillColor: C.muted, fontSize: "10px", fontFamily: FONT.mono };
...
function footer() {
  return row(C.card, "0 48px 16px", "center", [
    React.createElement(Text, {
      ...
      style: { color: C.muted, WebkitTextFillColor: C.muted, fontSize: "10px", fontFamily: FONT.mono, fontWeight: "700", letterSpacing: "2.5px", textTransform: "uppercase", margin: "0 0 12px" },
    }, "© 2026 Dialed By H — dialedbyhenry.com"),
    React.createElement(Text, {
      key: "d", className: "disclaimer-text",
      style: { color: C.disclaimer, WebkitTextFillColor: C.disclaimer, fontSize: "10px", fontFamily: FONT.body, lineHeight: "1.6", margin: "0 0 12px" },
    ...
    React.createElement(Link, {
      ...
      style: { color: C.muted, WebkitTextFillColor: C.muted, fontSize: "10px", fontFamily: FONT.mono, fontWeight: "700", letterSpacing: "2.5px", textTransform: "uppercase", textDecoration: "underline" },
    }, "Privacy & Terms"),
  ]);
}
    ...
    React.createElement("tr", null,
      React.createElement("td", {
        ...
        style: {
          ...
          fontSize: "12px",
          fontWeight: "700",
          color: C.featureText, WebkitTextFillColor: C.featureText,
          letterSpacing: "1px",
          paddingTop: "3px",
        },
      }, number),
      React.createElement("td", { style: { paddingLeft: "16px", verticalAlign: "top" } },
        React.createElement(Text, {
          ...
          style: { color: C.heading, WebkitTextFillColor: C.heading, fontSize: "14px", fontWeight: "800", fontFamily: FONT.heading, margin: "0 0 4px", letterSpacing: "0.5px", textTransform: "uppercase", fontStretch: "125%" },
        }, title),
        React.createElement(Text, {
          className: "body-text feature-desc",
          style: { color: C.body, WebkitTextFillColor: C.body, fontSize: "13px", lineHeight: "1.65", fontFamily: FONT.body, margin: "0" },
        }, desc),
      )
    )
  );
...
function sectionLabel(text) {
  return row(C.card, "36px 48px 8px", "left",
    React.createElement(Text, {
      className: "muted-text",
      style: { color: C.muted, WebkitTextFillColor: C.muted, fontSize: "10px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "4px", textTransform: "uppercase", margin: "0 0 22px" },
    }, text)
  );
}
    ...
    emailShell([
      ...
      row(C.card, "38px 48px 24px", "left", [
        ...
        React.createElement(Text, {
          ...
          style: { color: C.body, WebkitTextFillColor: C.body, fontSize: "15px", lineHeight: "1.75", margin: "0 0 16px", fontFamily: FONT.body },
        ...
        React.createElement(Text, {
          ...
          style: { color: C.body, WebkitTextFillColor: C.body, fontSize: "15px", lineHeight: "1.75", margin: "0", fontFamily: FONT.body },
