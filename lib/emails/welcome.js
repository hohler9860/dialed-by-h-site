...
function howItWorks() {
  return React.createElement("tr", null,
    React.createElement("td", { bgcolor: "#111111", className: "email-bg-dark", style: { backgroundColor: "#111111", padding: "42px 48px" } }, [
      React.createElement(Text, { key: "l", style: { color: "#7a7a7a", fontSize: "10px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "4px", textTransform: "uppercase", margin: "0 0 24px" } }, "How I Work"),
      React.createElement("div", { key: "s1", style: { marginBottom: "18px" } }, howStep("01", "Tell me the hunt", "Reference, budget, timeline. One message and I take it from there.")),
      React.createElement("div", { key: "s2", style: { marginBottom: "18px" } }, howStep("02", "I source & verify", "Live market access, condition checked, authenticity confirmed before you ever commit.")),
      React.createElement("div", { key: "s3" }, howStep("03", "Delivered, insured", "Full documentation and insured shipping or in-market hand-delivery. Door to door.", true)),
    ])
  );
}
    ...
    emailShell([
      ...
      row(C.card, "30px 48px 4px", "left", [
        React.createElement(Text, { key: "b1", className: "body-text body-main",
          ...
          "I’m Henry. I source Rolex, Patek, AP, F.P. Journe and the independents most dealers can’t get, across Boston, New York, and Miami. You’re now on the short list that hears first when something rare surfaces."),
        React.createElement(Text, { key: "b2", className: "body-text body-main",
          ...
          "Chasing a specific reference? Just reply to this email and I’ll get on it."),
      ]),
