...
function footer() {
  return row(C.card, "0 48px 16px", "center", [
    React.createElement(Text, {
      ...
      style: { color: C.muted, fontSize: "10px", fontFamily: FONT.mono, letterSpacing: "2.5px", textTransform: "uppercase", margin: "0 0 10px" },
    }, "\u00A9 2026 Dialed By H"),
    React.createElement(Text, {
    ...
    React.createElement(Link, {
      ...
      style: { color: C.muted, fontSize: "10px", fontFamily: FONT.mono, letterSpacing: "2.5px", textTransform: "uppercase", textDecoration: "none" },
    }, "Privacy & Terms"),
  ]);
}
...
function signoff(text) {
  return row(C.card, "32px 48px 8px", "left", [
    ...
    React.createElement(Text, {
      ...
      style: { color: C.heading, fontSize: "15px", fontFamily: FONT.heading, margin: "0 0 2px", fontWeight: "800", textTransform: "uppercase", letterSpacing: "1px", fontStretch: "125%" },
    }, "Henry"),
  ]);
}
    ...
    React.createElement("tr", null,
      React.createElement("td", { style: { verticalAlign: "top" } },
        ...
        React.createElement(Text, {
          ...
          style: { color: C.heading, fontSize: "36px", fontWeight: "800", letterSpacing: "-0.5px", lineHeight: "1.05", margin: "0", fontFamily: FONT.heading, textTransform: "uppercase", fontStretch: "125%" },
        }, headline)
      ),
      React.createElement("td", { width: "112", style: { verticalAlign: "top", paddingLeft: "18px" } },
        React.createElement(Img, {
          src: sticker, alt: "", width: "112",
          className: "animate-fade animate-delay-1",
  ...
  return React.createElement(
    ...
    emailShell([
      ...
      row(C.card, "40px 48px 28px", "left", [
        React.createElement("div", { key: "hdr" }, headerBlock("Private List", greeting, firstName || "welcome")),
        React.createElement(Text, {
      ...
      row(C.card, "36px 48px 8px", "left",
        React.createElement(Text, {
          ...
          style: { color: C.heading, fontSize: "10px", fontWeight: "700", fontFamily: FONT.mono, letterSpacing: "4px", textTransform: "uppercase", margin: "0 0 24px" },
        }, "What to Expect")
      ),
