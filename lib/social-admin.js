...
const OPERATIONS = new Set(['state','catalog','catalog-import','settings','integrations','create','edit','link','unschedule','resolve','generate','refresh','add-feed','remove-feed','add-source','verify-source','upload','metrics','disconnect']);
