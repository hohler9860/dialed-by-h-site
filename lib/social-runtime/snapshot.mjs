...
export const tables=['settings','sources','feeds','media','posts','leads','events','credentials','oauth','admin_handoffs','jobs','spend','post_verifications','editorial_reviews','media_catalog','post_image_checks','draft_batches'];
