...
// -> { standard, cutout|null, thumb, medium, alpha }
async function processWatchImage(buf) {
    ...
    return { standard, cutout, thumb, medium, alpha };
}

module.exports = {
    processWatchImage, renderScaled, variantPath, hasAlpha,
    SIZE, FILL, BG, CUTOUT_SIZE, THUMB_SIZE, MEDIUM_SIZE,
};
