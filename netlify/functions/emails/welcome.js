    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Text, { style: { color: C.heading, fontSize: "14px", fontWeight: "700", fontFamily: FONT.heading, margin: "0 0 6px", letterSpacing: "0.3px" } }, "Priority Alerts"),
          React.createElement(Text, { style: { color: C.body, fontSize: "14px", lineHeight: "1.65", fontFamily: FONT.body, margin: "0" } }, "New arrivals and off-market pieces sent to you before anyone else.")
        ),
        ...
        React.createElement(
          Section,
          { style: { padding: "0 40px 24px" } },
          React.createElement(Text, { style: { color: C.heading, fontSize: "14px", fontWeight: "700", fontFamily: FONT.heading, margin: "0 0 6px", letterSpacing: "0.3px" } }, "Personal Sourcing"),
          React.createElement(Text, { style: { color: C.body, fontSize: "14px", lineHeight: "1.65", fontFamily: FONT.body, margin: "0" } }, "Tell me what you\u2019re looking for and I\u2019ll tap my global network to find it.")
        ),
        ...
        React.createElement(
          Section,
          { style: { padding: "0 40px 24px" } },
          React.createElement(Text, { style: { color: C.heading, fontSize: "14px", fontWeight: "700", fontFamily: FONT.heading, margin: "0 0 6px", letterSpacing: "0.3px" } }, "Full Concierge Service"),
          React.createElement(Text, { style: { color: C.body, fontSize: "14px", lineHeight: "1.65", fontFamily: FONT.body, margin: "0" } }, "Authentication, documentation, insured delivery. Every detail handled.")
        ),
